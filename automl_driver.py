...
workspace_name = "wkspc-1" # PLACEHOLDER
subscription_id = "193e3a3e-d51c-4695-8abe-e58ed59b83c9" # PLACEHOLDER
resource_group = "felipebghello-rg" # PLACEHOLDER
experiment_name = "mslearn-bike-rental" # PLACEHOLDER
iteration = "0"  # PLACEHOLDER
run_id = "AutoML_10130521-b795-4dad-a761-ac7258e79c98_0"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'save_mlflow':True,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'whitelist_models':['RandomForest','LightGBM'],'compute_target':'cluster-ai-test','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':0.085,'experiment_timeout_minutes':30,'featurization':{'_blocked_transformers':[],'_column_purposes':{},'_transformer_params':{'Imputer':[]},'_drop_columns':None},'hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':30,'max_concurrent_iterations':2,'metric_operation':'minimize','model_explainability':True,'n_cross_validations':None,'name':'mslearn-bike-rental','path':'./sample_projects/mslearn-bike-rental','primary_metric':'normalized_root_mean_squared_error','region':'brazilsouth','resource_group':'felipebghello-rg','subscription_id':'193e3a3e-d51c-4695-8abe-e58ed59b83c9','task_type':'regression','validation_size':None,'test_size':None,'vm_type':'STANDARD_DS11_V2','workspace_name':'wkspc-1','label_column_name':'rentals','enable_batch_run':True,'dataset_id':'1853a470-e74b-4abd-bc27-ba0cbda54d76'} # PLACEHOLDER
...
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"1853a470-e74b-4abd-bc27-ba0cbda54d76\"}}" # PLACEHOLDER
